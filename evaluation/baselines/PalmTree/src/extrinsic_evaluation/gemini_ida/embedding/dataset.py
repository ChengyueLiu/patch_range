...
class BatchGenerator():
    ...
    def create_sample_space(self, training_dataset):
        ...
        for input_path in training_dataset:
        ...
        print('loading')
        func_cnt = 0
        for ida_path in tqdm(to_handle):
            # load '.ida' file
        ...
        print(f'Total functions: {func_cnt} with {len(self.train_sample.keys())} unique functions')
