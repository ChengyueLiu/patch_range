def get_default_config(dataset_path='dataset.pkl'):
    """The default configs."""
    model_type = 'matching'
    ...
    graph_matching_net_config['similarity'] = 'dotproduct'  # other: dotproduct, euclidean, cosine
    return dict(
        encoder=dict(
        ...
        cp_path='saved/checkpoint_microcode_68.pt',
        data=dict(
            ...
            dataset_params=dict(
                ...
                train_dataset_path='gen_dataset/microcode_noinline_train.pkl',
                valid_dataset_path='gen_dataset/microcode_noinline_validation.pkl')),
        training=dict(
            batch_size=80,
            learning_rate=1e-4,
            mode='pair',
            loss='cosine',  # other: hamming, margin, cosine
            margin=1.0,
