...
def train_dp(model, args, train_set, valid_set, logger):
    ...
    train_dataloader = DataLoader(train_set, batch_size=args.batch_size, num_workers=0, shuffle=True)
    valid_dataloader = DataLoader(valid_set, batch_size=args.eval_batch_size, num_workers=0, shuffle=True)
